...
--
-- Como usar:
-- 1. Abra o Supabase do projeto novo.
-- 2. Va em SQL Editor.
-- 3. Cole este arquivo inteiro e execute.
-- 4. Depois cadastre a Paola pelo site.
-- 5. Volte ao SQL Editor e rode o UPDATE de admin no final deste arquivo.
--
-- Importante:
...
-- Depois que a Paola criar a conta dela pelo site, substitua o email abaixo
-- e rode apenas esta linha para liberar o acesso administrativo futuro:
--
-- update public.profiles
-- set role = 'admin'
-- where email = 'email-da-paola@exemplo.com';
--
-- Conferencia rapida:
--
-- select id, nome, whatsapp, email, status, role, created_at
-- from public.profiles
